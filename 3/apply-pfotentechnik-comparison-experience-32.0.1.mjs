...
const PATCH = "pfotentechnik-comparison-experience-32.0.1";
...
const files = {
  ...
  test: path.join(root, "apps/pfotentechnik/test/pfotentechnik-comparison-experience-32.0.1.test.mjs")
};
...
try {
  ...
  shell = shell.replace(/data-layout-engine="[^"]*"/, 'data-layout-engine="31.0.0" data-comparison-experience="32.0.1"');
  if (!shell.includes('data-comparison-experience="32.0.1"')) {
    shell = shell.replace(/<div class="comparison-shell"/, '<div class="comparison-shell" data-comparison-experience="32.0.1"');
  }
  ...
  if (fs.existsSync(dist)) {
    ...
    if (!html.includes('data-comparison-experience="32.0.1"')) {
