 ...
 *
 * Nutzung:
 *   node pfotentechnik-comparison-platform-refactor-10.0.0.mjs
 *   node pfotentechnik-comparison-platform-refactor-10.0.0.mjs --check
 *   node pfotentechnik-comparison-platform-refactor-10.0.0.mjs --push
 *   node pfotentechnik-comparison-platform-refactor-10.0.0.mjs --no-commit
 *   node pfotentechnik-comparison-platform-refactor-10.0.0.mjs --allow-dirty
 *   node pfotentechnik-comparison-platform-refactor-10.0.0.mjs --branch=<name>
 */
...
`;
  ...
  } else if (!viewModel.includes('? "Preis-Leistung"\n                : index === 1')) {
    fail("buildComparisonViewModel: Badge-Anker nicht gefunden.");
  }
