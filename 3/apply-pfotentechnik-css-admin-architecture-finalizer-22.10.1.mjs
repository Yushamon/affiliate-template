...
const NAME = "pfotentechnik-css-admin-architecture-finalizer-22.10.1";
...
const ownership = {
  ...
  layers: {
    foundation: {
      ...
      owns: [".seo-shell", ".seo-page-header", ".seo-subtitle"]
    },
    panels: {
...
const tests = {
  ...
  "css-admin-foundation.test.mjs": focusedTest(
    "foundation",
    [".seo-shell", ".seo-page-header", ".seo-subtitle"],
...
const report = {
  patch: NAME,
  replaces: "22.10.0",
  fixedIssue: "Ungültiger Foundation-Ownership-Marker .seo-title wurde durch den im Bestand vorhandenen Marker .seo-subtitle ersetzt.",
  status: "finalized",
...
const reportMd = `# SEO Admin CSS Architecture 22.10.1

## Korrektur gegenüber 22.10.0

Der statisch eingetragene Marker \`.seo-title\` existiert im aktuellen
Foundation-Layer nicht. 22.10.1 verwendet stattdessen den tatsächlich
vorhandenen Marker \`.seo-subtitle\`.
