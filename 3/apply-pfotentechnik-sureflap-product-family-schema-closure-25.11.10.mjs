...
const PATCH = "pfotentechnik-sureflap-product-family-schema-closure-25.11.10";
...
const FILES = {
  ...
  test: path.join(APP, "test/sureflap-product-family-schema-closure-25.11.10.test.mjs"),
};
...
const TARGETS = [FILES.connect, FILES.standard, FILES.dualscan, FILES.test];
...
test("Standard besitzt den erforderlichen neutralen Rating-Platzhalter", () => {
