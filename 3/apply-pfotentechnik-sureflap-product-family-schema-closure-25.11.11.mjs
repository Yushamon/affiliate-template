...
const PATCH = "pfotentechnik-sureflap-product-family-schema-closure-25.11.11";
...
const FILES = {
  ...
  test: path.join(APP, "test/sureflap-product-family-schema-closure-25.11.11.test.mjs"),
};
