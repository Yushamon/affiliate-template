...
const main = async () => {
  ...
  const touched = [...Object.keys(FILES), ...REMOVALS, "packages/affiliate-core/src/components/comparison/ComparisonExplorer.astro", "apps/pfotentechnik/src/domain/comparison/buildComparisonViewModel.ts", "apps/pfotentechnik/package.json", DEFAULT_HERO];
  ...
  if (!skipChecks) {
    ...
    run(root, "npm", ["--workspace", "apps/pfotentechnik", "run", "comparison:release:check"]);
