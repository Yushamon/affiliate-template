...
const PATCH = "pfotentechnik-external-evidence-batch-5-33.8.6";
...
const testFile = path.join(app, "test", "external-evidence-batch-5-33.8.6.test.mjs");
...
test("Top-Level-PfotenTechnik-Ratings bleiben erhalten",()=>{
  const expected={
