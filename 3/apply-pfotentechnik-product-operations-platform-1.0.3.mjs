...
function preflight() {
  ...
  if (dirty) {
    console.log("[product-operations-1.0.3] Sichere Teilinstallation bzw. abgebrochene Phase 4 erkannt. Installation wird fortgesetzt.");
  }
}
...
async function main() {
  ...
  // Astro interpretiert generische Arrow Functions in Inline-Skripten als JSX.
  // Die korrigierte Cockpit-Datei wird auch bei bereits committeter Phase 2 erneut übernommen.
  copyPayload("apps/pfotentechnik/src/pages/admin/seo/prices.astro");
