# PfotenTechnik Product Operations Platform 1.0.3
...
```powershell
node .\apply-pfotentechnik-product-operations-platform-1.0.3.mjs --publish
```
...
Behebt die Astro-Compiler-Mehrdeutigkeit einer generischen Arrow Function in `prices.astro`. Bei bereits installierten Phasen 1–3 wird ausschließlich die korrigierte Cockpit-Datei übernommen und Phase 4 fortgesetzt.
