...
const PATCH = "pfotentechnik-comparison-experience-32.0.0";
...
const files = {
  ...
  test: path.join(root, "apps/pfotentechnik/test/pfotentechnik-comparison-experience-32.0.0.test.mjs")
};
...
test("genau ein aktiver Vergleichs-CSS-Owner", () => {
  assert.match(shell, /import "\.\/comparison-experience\.css";/);
...
test("Shell ist auf Experience 32 markiert", () => {
  assert.match(shell, /data-comparison-experience="32\.0\.0"/);
});
`;
...
try {
  ...
  shell = shell.replace(/data-layout-engine="[^"]*"/, 'data-layout-engine="31.0.0" data-comparison-experience="32.0.0"');
  if (!shell.includes('data-comparison-experience="32.0.0"')) {
    shell = shell.replace(/<div class="comparison-shell"/, '<div class="comparison-shell" data-comparison-experience="32.0.0"');
  }
  ...
  if (fs.existsSync(dist)) {
    ...
    if (!html.includes('data-comparison-experience="32.0.0"')) {
