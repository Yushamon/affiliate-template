...
const PATCH = "pfotentechnik-topical-authority-journey-completion-26.8.1";
...
const TEST_RELATIVE = path.join(
  APP_RELATIVE,
  "test",
  "topical-authority-journey-completion-26.8.1.test.mjs",
);
...
try {
  ...
  const reportFile = path.join(
    ...
    "reports",
    "topical-authority",
    "journey-completion-validation-26.8.1.json",
  );
