...
const PATHS = {
  ...
  css: "packages/affiliate-core/src/components/comparison/comparison-premium-fix-15.3.1.css",
...
const css = `/* PfotenTechnik Comparison Premium UI Fix 15.3.1 */
:root {
...
const cssImport = 'import "./comparison-premium-fix-15.3.1.css";';
...
shell = shell.replace(/data-comparison-cover-version="[^"]+"/, 'data-comparison-cover-version="15.3.1"');
...
header = header.replace('data-site-header>', 'data-site-header data-comparison-header-fix="15.3.1">');
