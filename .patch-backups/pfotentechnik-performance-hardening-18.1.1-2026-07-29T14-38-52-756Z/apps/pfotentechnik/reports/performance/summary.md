...
| --- | ---: | ---: | ---: |
| Build-Dauer | 5:57 min | 3:47 min | −36,4 % |
| Routengenerierung | 4:40 min | 3:31 min | −24,6 % |
...
Die absolute Build-Dauer profitiert auch vom warmen Bildcache; die separat beobachtete Routengenerierung zeigt den belastbareren Architekturgewinn. Besonders deutlich ist die vermiedene Doppelarbeit im SEO-Admin: `/admin/seo/prompts/` sank von 10,85 s auf 43 ms und `/admin/seo/tasks/` von 22,22 s auf 47 ms.
