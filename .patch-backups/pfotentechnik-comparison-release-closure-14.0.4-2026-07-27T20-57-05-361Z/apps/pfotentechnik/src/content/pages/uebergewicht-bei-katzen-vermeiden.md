...
type: knowledge
layout: knowledge
description: "Übergewicht bei Katzen früh erkennen und vermeiden: Körperzustand beurteilen, Portionen berechnen, Leckerlis einplanen und Bewegung sinnvoll fördern."
...
tags: ["katze", "uebergewicht", "ernaehrung", "portionen", "bewegung", "body-condition-score", "gewichtsmanagement"]
hub:
  sections: ["wissen"]
  title: "Übergewicht bei Katzen vermeiden"
  description: "Körperzustand, Portionen, Snacks, Bewegung und Fütterungsroutine alltagstauglich kontrollieren."
  order: 52
seo:
  title: "Übergewicht bei Katzen vermeiden: Futter und Gewicht"
  description: "So bleibt deine Katze im Idealgewicht: BCS prüfen, Portionen berechnen, Leckerlis einrechnen, Gewicht dokumentieren und Futterneid verhindern."
  canonical: "/uebergewicht-bei-katzen-vermeiden/"
  sitemap: true
  priority: 0.8
  changefreq: "yearly"
related: { tags: ["katze", "ernaehrung", "portionen", "futterautomat", "gewichtsmanagement"], limit: 4 }
linking:
  keywords:
    - "Übergewicht Katze"
    - "Katze zu dick"
...
faq:
  - question: "Wie erkenne ich Übergewicht bei meiner Katze?"
    answer: "Gewicht und Körperform sollten gemeinsam beurteilt werden. Beim idealen Body Condition Score sind die Rippen unter einer dünnen Fettschicht tastbar, von oben ist eine Taille erkennbar und seitlich wirkt der Bauch leicht aufgezogen."
  - question: "Welcher Body Condition Score ist bei Katzen ideal?"
    answer: "Auf der verbreiteten neunstufigen Skala gilt 5 von 9 als ideal. Werte von 6 bis 7 sprechen für Übergewicht, 8 bis 9 für deutliche Adipositas. Die Einordnung sollte bei Unsicherheit tierärztlich bestätigt werden."
  - question: "Wie viel sollte eine Katze pro Tag fressen?"
    answer: "Eine pauschale Grammzahl ist nicht seriös. Die passende Menge hängt unter anderem von Zielgewicht, Alter, Aktivität, Kastrationsstatus, Gesundheitszustand und der Energiedichte des Futters ab."
  - question: "Wie berechne ich die Futtermenge aus der Kalorienangabe?"
    answer: "Teile den festgelegten Tagesbedarf in Kilokalorien durch die Kilokalorien pro 100 Gramm des Futters und multipliziere mit 100. Der Tagesbedarf selbst sollte anhand von Körperzustand und Gewichtsverlauf überprüft werden."
  - question: "Darf eine übergewichtige Katze einfach weniger Futter bekommen?"
    answer: "Eine kleine Anpassung kann bei leichtem Übergewicht sinnvoll sein. Starke oder ungeplante Kürzungen sind riskant, weil Nährstoffversorgung und Futteraufnahme gesichert bleiben müssen. Deutlich übergewichtige Katzen sollten kontrolliert und tierärztlich begleitet abnehmen."
  - question: "Wie schnell darf eine Katze abnehmen?"
    answer: "Eine langsame, kontrollierte Abnahme ist entscheidend. Häufig wird ungefähr ein Prozent des Körpergewichts pro Woche angestrebt, das passende Ziel hängt aber vom Gesundheitszustand und dem individuellen Plan ab."
  - question: "Warum ist schnelles Abnehmen bei Katzen gefährlich?"
    answer: "Bei zu geringer Futteraufnahme oder rascher Gewichtsabnahme kann insbesondere bei übergewichtigen Katzen eine hepatische Lipidose entstehen. Diese schwere Lebererkrankung ist ein medizinischer Notfall."
  - question: "Zählen Leckerlis zur Tagesration?"
    answer: "Ja. Leckerlis, Schlecksnacks, Kauartikel, Tischreste und Futter zur Medikamentengabe liefern Energie. Sie sollten zusammen weniger als zehn Prozent der täglichen Kalorien ausmachen, sofern die Tierarztpraxis nichts anderes empfiehlt."
  - question: "Ist Nassfutter grundsätzlich besser für übergewichtige Katzen?"
    answer: "Nicht grundsätzlich. Viele Nassfutter haben durch ihren hohen Wasseranteil eine geringere Energiedichte, die tatsächlichen Kalorien unterscheiden sich jedoch deutlich. Entscheidend sind Gesamtration, Verträglichkeit und Nährstoffversorgung."
  - question: "Wie oft sollte ich meine Katze wiegen?"
    answer: "Zur Vorbeugung ist eine Kontrolle alle zwei bis vier Wochen unter vergleichbaren Bedingungen sinnvoll. Während einer geplanten Gewichtsabnahme können engere Intervalle nötig sein."
  - question: "Hilft ein Futterautomat gegen Übergewicht?"
    answer: "Ein Automat kann abgewogene Portionen zu festen Zeiten ausgeben und Doppelgaben reduzieren. Er berechnet aber weder den Energiebedarf noch garantiert er, dass im Mehrkatzenhaushalt die richtige Katze frisst."
  - question: "Wie verhindere ich Futterdiebstahl im Mehrkatzenhaushalt?"
    answer: "Füttere die Katzen getrennt, beaufsichtige Mahlzeiten oder nutze individuell zugängliche Futterplätze. Bei dauerhaft unterschiedlichen Rationen kann ein Mikrochip-Futterautomat sinnvoll sein."
...
- Körpergewicht,
- Body Condition Score, kurz BCS,
- Muscle Condition Score, kurz MCS,
- Verlauf über mehrere Wochen oder Monate.
...
- deutlich hervortretende Schulterblätter,
- eine knochige Wirbelsäule trotz breitem Bauch,
- weniger Muskulatur an Hinterbeinen und Becken,
- nachlassende Sprungkraft,
- Schwierigkeiten beim Aufstehen oder Klettern.
...
- immer mit oder immer ohne Transportbox,
- Gewicht zeitnah notieren.
...
- Zielgewicht und aktuellem BCS,
- Alter und Aktivität,
- Kastrationsstatus,
- Gesundheitszustand,
- Kalorien pro 100 Gramm oder pro Portion,
- zusätzlichem Futter und Leckerlis.
...
- festgelegter Tagesbedarf: 200 kcal
- Trockenfutter: 380 kcal pro 100 g
- Rechnung: 200 ÷ 380 × 100
- Ergebnis: rund 53 g pro Tag
...
- Tischreste,
- Schlecksnacks,
- Nahrungsergänzungen mit Energie,
- Trainingsfutter,
- Kauartikel.
...
- Angelspiele mit kontrollierter Beutebewegung,
- Futtersuche in mehreren kleinen Verstecken,
- einfache Futterpuzzles,
- erhöhte Liegeplätze und sichere Kletterwege,
- Kartons, Tunnel und wechselnde Verstecke,
- kurze Clickerübungen,
- Bälle oder leichte Spielzeuge, die sich gut verfolgen lassen.
...
- weniger spontane Nachfüllungen,
- dokumentierbarer Fütterungsplan,
- Entlastung bei frühen oder späten Mahlzeiten.

Grenzen:

- Portionsstufen entsprechen nicht immer einer festen Grammzahl.
- Krokettenform und Füllstand können die Ausgabe beeinflussen.
- Die Katze kann Futter liegen lassen oder ein anderes Tier frisst es.
- Snacks außerhalb des Automaten bleiben unberücksichtigt.
- Das Gerät erkennt keinen falschen Kalorienplan.
...
- Ausgangsgewicht und BCS dokumentieren.
- Tagesration in Kilokalorien und Gramm ermitteln.
- Alle regelmäßig gegebenen Snacks erfassen.
- Fütterungsverantwortung im Haushalt klären.
- Für jede Katze einen eigenen Futterplan anlegen.

### Täglich

- gesamte Tagesration abwiegen,
- Leckerlis daraus entnehmen oder separat notieren,
- kurze Bewegungs- oder Sucheinheiten anbieten,
- prüfen, welche Katze tatsächlich frisst.

### Alle zwei bis vier Wochen

- unter vergleichbaren Bedingungen wiegen,
- BCS erneut prüfen,
- Aktivität und Appetit notieren,
- Ration nur schrittweise verändern.
...
- realistisches Zielgewicht,
- berechnete Tagesenergie,
- geeignetes Allein- oder Diätfutter,
- gesicherte Futteraufnahme,
- regelmäßige Gewichtskontrollen,
- Anpassung bei zu schneller oder ausbleibender Abnahme,
...
- deutlich weniger oder keine Futteraufnahme,
...
- der BCS deutlich über dem Idealbereich liegt,
- das Gewicht ohne erkennbare Ursache steigt oder fällt,
- die Katze weniger frisst,
- starker Durst oder häufigeres Urinieren auffällt,
- Bewegung schmerzhaft wirkt,
- Muskelabbau erkennbar ist,
- Medikamente oder Erkrankungen den Bedarf beeinflussen,
- eine Rationsanpassung über mehrere Wochen keine Wirkung zeigt,
- eine gezielte Gewichtsabnahme geplant ist.
...
- [WSAVA: Body Condition Score for Cats](https://wsava.org/wp-content/uploads/2020/08/Body-Condition-Score-cat-updated-August-2020.pdf)
...
- [WSAVA: Principles of Wellness](https://wsava.org/wp-content/uploads/2025/06/Principles-of-Wellness-FINAL.pdf)
- [International Cat Care: Obesity in Cats](https://icatcare.org/articles/obesity-in-cats)
- [Merck Veterinary Manual: Feline Hepatic Lipidosis](https://www.merckvetmanual.com/digestive-system/hepatic-diseases-of-small-animals/feline-hepatic-lipidosis)
