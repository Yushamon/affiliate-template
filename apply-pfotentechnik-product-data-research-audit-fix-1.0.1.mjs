...
const PATCH = "pfotentechnik-product-data-research-audit-fix-1.0.1";
...
function read(file) {
  ...
  // Alle Patch-Muster arbeiten intern mit LF. Dadurch funktioniert der
  // Installer unter Windows (CRLF), macOS und Linux identisch.
