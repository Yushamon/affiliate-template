...
1. Muss das Futter aktiv gekühlt werden?
2. Wie viele spätere Mahlzeiten werden tatsächlich benötigt?
3. Muss das Gerät ohne Netzstrom weiterarbeiten?
4. Muss eine bestimmte Katze exklusiven Zugang erhalten?
...
### Beste flexible Sechs-Fächer-Lösung: Catit PIXI Smart 6-Meal Feeder
...
### Beste Offline-Zeitsteuerung: Cat Mate C500
...
## Aktive Kühlung und Kühlakku sind nicht dasselbe
...
## Die Zahl der Fächer wird häufig falsch gelesen
...
## Stromausfall: Öffnen und Kühlen getrennt bewerten

Bei einem Stromausfall stellen sich zwei verschiedene Fragen:

1. Öffnet das nächste Fach weiterhin?
2. Bleibt das Futter weiterhin gekühlt?
...
- vollständig entnehmbare Futterschalen
- glatte Kontaktflächen ohne schwer erreichbare Spalten
- spülmaschinengeeignete Einsätze, sofern vom Hersteller freigegeben
- gut erreichbare Deckelränder und Dichtungen
- eine elektrische Basis, die sich reinigen lässt, ohne Wasser in die Mechanik zu bringen
- vollständig trockene Teile vor der nächsten Befüllung
...
## Mehrkatzenhaushalt: Zeitsteuerung verhindert keinen Futterklau
...
## Für Katzen und kleine Hunde, nicht automatisch für große Hunde
...
- zu kleine Fächer
- zu niedrige Fressposition
- zu schmale Öffnung
- unzureichender Manipulationsschutz
- zu geringe maximale Mahlzeit

Ein großes Gehäuse oder sechs Fächer sagen wenig darüber aus, ob eine vollständige Hunderation hineinpasst.

## App oder lokale Bedienung?
...
### Ein Mikrochip-Napf übernimmt den ganzen Fütterungsplan

Der SureFeed schützt den Zugang, dosiert aber nicht automatisch und öffnet nicht nach Uhrzeit.

### Aktive Kühlung macht Nassfutter unbegrenzt haltbar
...
- Kühlprinzip und Temperaturkontrolle: 25 %
- Hygiene und Reinigung: 20 %
- tatsächlich nutzbare Mahlzeiten: 15 %
- Ausfallsicherheit: 15 %
- Zuverlässigkeit der Steuerung: 10 %
- Zugangskontrolle im Mehrtierhaushalt: 10 %
- App und Zusatzfunktionen: 5 %
...
Herstellerübersichten: [PETLIBRO](/hersteller/petlibro/), [PetSafe](/hersteller/petsafe/), [Catit](/hersteller/catit/), [Cat Mate](/hersteller/cat-mate/) und [SureFeed](/hersteller/surefeed/).
...
## Wann Polar, FreshFeed oder ein Kühlakku-System?
...
- Der Kühlakku wird nur teilweise durchgefroren oder liegt nicht plan unter allen Fächern.
- Warm eingefülltes Futter muss erst im Gerät heruntergekühlt werden.
- Ein Stromausfall wird mit einem WLAN-Ausfall verwechselt: Der Zeitplan kann weiterlaufen, während die aktive Kühlung ausfällt.
- Geruch und Oberfläche werden geprüft, die tatsächliche Temperatur aber nie.
- Ein Mehrkatzenhaushalt nutzt einen offenen Drehteller, obwohl Zugangsschutz benötigt wird.
