...
seoTitle: "Wie viele Mahlzeiten braucht eine Katze am Tag?"
slug: "wie-viele-mahlzeiten-katze"
...
premiumBlocks:
  - type: "answer"
    eyebrow: "Kurzantwort"
    title: "Mehrere kleine Mahlzeiten passen häufig zum Katzenverhalten"
    text: "Viele Katzen kommen mit mehreren kleinen Mahlzeiten über den Tag gut zurecht. Eine starre Idealzahl gibt es nicht: Tagesration, Alter, Gesundheit, Futterart, Aktivität und Zusammenleben mit anderen Tieren bestimmen den Plan. Wichtig ist, dass die Gesamtmenge kontrolliert bleibt und jede Katze stressfrei Zugang hat. Ein Automat kann Zeiten verteilen, aber weder Bedarf noch Futteraufnahme sicher beurteilen."
  - type: "quickFacts"
    eyebrow: "Plan erstellen"
    title: "Drei Größen statt einer festen Zahl"
    cards:
      - label: "Gesamt"
        title: "Tagesration"
        text: "Zuerst die passende Gesamtmenge festlegen und alle Extras einrechnen."
      - label: "Verteilung"
        title: "Kleine Mahlzeiten"
        text: "Danach die Menge in alltagstaugliche Fütterungszeiten aufteilen."
      - label: "Zugang"
...
comparisonRecommendation:
  ...
  tableTitle: "Technik für verteilte Katzenmahlzeiten"
  cardsTitle: "Drei Modelle im Kontext"
  criteria: ["Kleine Dosierschritte", "Zahl der Zeitpläne", "Zugang", "Protokoll", "Lautstärke", "Reinigung"]
faq:
  - question: "Sind sechs kleine Mahlzeiten besser als zwei?"
...
- [Studie zu zwei oder sechs Mahlzeiten im Gewichtsmanagement](https://pubmed.ncbi.nlm.nih.gov/35762268/)
