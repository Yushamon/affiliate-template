...
seoTitle: "Wie funktioniert ein Futterautomat für Hund und Katze?"
slug: "wie-funktioniert-ein-futterautomat"
description: "Aufbau, Portionierung, Zeitsteuerung und Grenzen automatischer Futterspender verständlich erklärt."
seoDescription: "So funktionieren Futterautomaten: Vorrat, Dosierung, Zeitplan, App, Notstrom und Reinigung bei Modellen für Hunde und Katzen."
...
premiumBlocks:
  - type: "answer"
    eyebrow: "Kurzantwort"
    title: "Ein Zeitplan löst eine mechanische Ausgabe aus"
    text: "Ein Futterautomat speichert Fütterungszeiten und gibt zur festgelegten Uhrzeit eine definierte Menge aus. Vorratsmodelle transportieren Trockenfutter über ein Dosierrad oder eine Förderschnecke zum Napf. Fachautomaten öffnen oder drehen dagegen vorbereitete Schalen und eignen sich je nach Bauart auch für Nassfutter. App und Kamera sind Zusatzfunktionen; die Kernaufgabe bleibt eine zuverlässige, hygienische Portionierung."
  - type: "quickFacts"
    eyebrow: "System verstehen"
    title: "Die drei wichtigsten Baugruppen"
    cards:
      - label: "Vorrat"
        title: "Behälter und Futterweg"
        text: "Sie halten Futter trocken und führen es kontrolliert zur Dosiereinheit."
      - label: "Steuerung"
        title: "Uhr, Speicher und Motor"
        text: "Ein lokaler Zeitplan startet die Ausgabe; WLAN sollte dafür nicht zwingend nötig sein."
      - label: "Ausgabe"
...
comparisonRecommendation:
  ...
  tableTitle: "Vorrats- und Fachautomaten im Vergleich"
  cardsTitle: "Drei Funktionsprinzipien im Katalog"
  criteria: ["Dosierprinzip", "Futterart", "Zeitplan", "Offline-Betrieb", "Reinigung", "Ausfallsicherheit"]
faq:
  - question: "Funktioniert ein Futterautomat auch ohne Internet?"
...
- [FEDIAF: Auswahl eines geeigneten Futters für Hund und Katze](https://europeanpetfood.org/pet-food-facts/fact-sheets/nutrition/choosing-the-right-food-for-your-dog-and-cat/)

## Interne Links und weiterführende Ratgeber

Den Überblick über Bauarten und aktuelle Modelle bietet [Smarte Futterautomaten](/smarte-futterautomaten/). Danach helfen [Welcher Futterautomat ist der richtige?](/welcher-futterautomat-ist-der-richtige/), [Futterautomat im Urlaub](/futterautomat-im-urlaub/) und [Futterautomat und Ernährung](/futterautomat-und-ernaehrung/) bei der konkreten Planung. Passende technische Beispiele sind der [Petlibro Granary WiFi Feeder](/produkt/petlibro-granary-wifi-feeder/) und der fachbasierte [Cat Mate C500](/produkt/cat-mate-c500/).
