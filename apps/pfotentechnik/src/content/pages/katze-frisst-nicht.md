---
title: "Katze frisst nicht: Ursachen, Warnzeichen und richtiges Vorgehen"
slug: "katze-frisst-nicht"
type: knowledge
layout: knowledge
description: "Was zu tun ist, wenn eine Katze nicht frisst: Dringlichkeit einschätzen, Warnzeichen erkennen, Futteraufnahme prüfen und tierärztliche Hilfe richtig einordnen."
category: "katzengesundheit"
linking:
  keywords: ["Katze frisst nicht", "Katze verweigert Futter", "Appetitlosigkeit Katze", "Katze isst nicht"]
  contexts: ["katzengesundheit", "fütterung", "futterautomat", "nassfutter"]
  priority: "high"
categoryLabel: "Katzenwissen"
categoryPath: "/wissen/"
heroImage:
  src: "../../assets/images/guides/katze-frisst-nicht/hero.webp"
  alt: "Katze vor einem unberührten Futternapf, während Futtermenge, Verhalten und Warnzeichen kontrolliert werden."
publishedAt: "2026-07-15"
updatedAt: "2026-07-15"
author: { name: "PfotenTechnik Redaktion", role: "Redaktion" }
tags: ["katze", "appetitlosigkeit", "futterverweigerung", "gesundheit", "fütterung"]
hub:
  sections: ["wissen"]
  title: "Katze frisst nicht"
  description: "Dringlichkeit einschätzen, mögliche Ursachen erkennen und sinnvoll handeln."
  order: 52
seo:
  title: "Katze frisst nicht: Wann zum Tierarzt?"
  description: "Katze frisst nicht? So schätzen Sie die Dringlichkeit ein, erkennen Warnzeichen und wissen, was Sie bis zum Tierarzttermin sicher tun können."
  canonical: "/katze-frisst-nicht/"
  sitemap: true
  priority: 0.75
  changefreq: "yearly"
related: { tags: ["katze", "gesundheit", "fütterung"], limit: 4 }
faq:
  - question: "Wie lange darf eine Katze nichts fressen?"
    answer: "Eine erwachsene Katze sollte nicht einfach über längere Zeit beobachtet werden. Frisst sie seit etwa 24 Stunden nichts oder deutlich zu wenig, sollte sie tierärztlich untersucht werden. Bei Kitten, Senioren, übergewichtigen, trächtigen oder vorerkrankten Katzen sowie bei zusätzlichen Symptomen ist deutlich früher Hilfe nötig."
  - question: "Wann ist Futterverweigerung bei einer Katze ein Notfall?"
    answer: "Sofortige Hilfe ist nötig bei Atemnot, Kollaps, starker Schwäche, wiederholtem Erbrechen, aufgeblähtem oder schmerzhaftem Bauch, Vergiftungsverdacht, verschlucktem Fremdkörper, gelben oder sehr blassen Schleimhäuten sowie häufigem Pressen ohne Urin."
  - question: "Was kann ich tun, wenn meine Katze nicht frisst?"
    answer: "Prüfen Sie Allgemeinzustand, Wasseraufnahme, Urin und Kot, bieten Sie vertrautes Futter in kleiner Menge und ruhiger Umgebung an und notieren Sie die tatsächlich gefressene Menge. Zwangsfütterung, Humanmedikamente und eigenmächtige Appetitanreger sind ungeeignet."
  - question: "Warum geht meine Katze zum Napf, frisst aber nicht?"
    answer: "Das kann auf Übelkeit, Zahn- oder Maulschmerzen, Schluckbeschwerden, eine verstopfte Nase, Schmerzen beim Beugen oder eine erlernte Futteraversion hinweisen. Das Verhalten hilft bei der Einordnung, ersetzt aber keine Untersuchung."
  - question: "Kann Stress dazu führen, dass eine Katze nicht frisst?"
    answer: "Ja. Umzug, neue Tiere, Konflikte, ungewohnte Gerüche oder ein veränderter Futterplatz können die Futteraufnahme reduzieren. Stress sollte aber erst dann als Hauptursache gelten, wenn körperliche Erkrankungen angemessen ausgeschlossen wurden."
  - question: "Darf man eine Katze mit einer Spritze füttern?"
    answer: "Nicht ohne tierärztliche Anleitung. Gegen den Widerstand eingegebenes Futter kann eingeatmet werden, eine Futteraversion verstärken oder bei einer Schluckstörung gefährlich sein."
premiumBlocks:
  - type: answer
    eyebrow: "Kurz erklärt"
    title: "Nicht auf mehrere Tage warten"
    text: |
  ...
  - type: quickFacts
    ...
    cards:
      - label: "Sofort"
        title: "Atemnot, Kollaps oder starke Schmerzen"
      - label: "Heute"
        title: "keine Nahrung oder deutliche Verschlechterung"
      - label: "Beobachten"
        title: "nur kurz und bei gutem Allgemeinzustand"
      - label: "Dokumentieren"
        title: "Menge, Wasser, Urin, Kot und Symptome"
  - type: checklist
    eyebrow: "Für den Tierarzt"
...
Quelle: [Cornell Feline Health Center: Anorexia](https://www.vet.cornell.edu/departments-centers-and-institutes/cornell-feline-health-center/health-information/feline-health-topics/anorexia).

## Direkt zum passenden Problem

- [Die Katze frisst seit heute nichts](#wie-dringend-ist-die-situation)
- [Sie geht zum Napf, frisst aber nicht](#sie-geht-zum-napf-frisst-aber-nicht)
- [Sie riecht am Futter und dreht sich weg](#sie-riecht-am-futter-und-dreht-sich-weg)
- [Sie frisst nur Leckerli oder Soße](#sie-frisst-nur-leckerli-oder-soße)
- [Sie erbricht oder hat Durchfall](#erbrechen-und-durchfall)
- [Sie trinkt ebenfalls wenig](#wenn-die-katze-auch-wenig-trinkt)
- [Was kann ich zu Hause tun?](#was-du-zu-hause-sicher-tun-kannst)
- [Wann muss sie zum Tierarzt?](#wann-tierarztliche-hilfe-noetig-ist)

## Wie dringend ist die Situation?

![Entscheidungsbaum zur Dringlichkeit bei einer Katze, die nicht frisst](../../assets/images/guides/katze-frisst-nicht/urgency-flow.webp)
...
![Übersicht möglicher Ursachen für Futterverweigerung bei Katzen](../../assets/images/guides/katze-frisst-nicht/cause-map.webp)
...
![Sechs sichere Schritte zur Beobachtung und Unterstützung einer Katze mit vermindertem Appetit](../../assets/images/guides/katze-frisst-nicht/home-actions.webp)
...
Mehr zur Einordnung findest du im Ratgeber [Woran erkennt man, dass eine Katze zu wenig trinkt?](/woran-erkennt-man-dass-die-katze-zu-wenig-trinkt/).
...
![Checkliste mit Beobachtungen und Unterlagen für den Tierarzttermin](../../assets/images/guides/katze-frisst-nicht/vet-checklist.webp)
...
![Ampelübersicht zur Dringlichkeit bei Futterverweigerung einer Katze](../../assets/images/guides/katze-frisst-nicht/urgency-cards.webp)
...
- [VCA Animal Hospitals: Anorexia in Cats](https://vcahospitals.com/know-your-pet/anorexia-in-cats)
- [International Cat Care: Managing the cat that won't eat](https://icatcare.org/advice/managing-the-cat-that-wont-eat/)
- [MSD Veterinary Manual: Fatty Liver Disease in Cats](https://www.msdvetmanual.com/cat-owners/digestive-disorders-of-cats/fatty-liver-disease-in-cats)
