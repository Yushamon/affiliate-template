...
premiumBlocks:
  ...
  - type: "quickFacts"
    ...
    title: "Die passende Bauart auf einen Blick"
    cards:
  ...
  - type: "scenarios"
    ...
    cards:
      ...
      - label: "Gewichtsmanagement"
        ...
        text: "Wichtig sind reproduzierbare Ausgaben. Wiege mehrere Portionen mit dem tatsächlich verwendeten Futter nach."
      - label: "Beruf und Schichtdienst"
        title: "Ausfallsicherheit priorisieren"
        text: "Batterie-Backup, Füllstandshinweis und verlässlicher Offline-Betrieb sind wichtiger als Audio oder Effekte."
      - label: "Urlaub oder Wochenende"
        title: "Automat plus Betreuung"
        text: "Ein Gerät ersetzt keine Person, die Wasser, Technik, Hygiene und Gesundheitszustand regelmäßig kontrolliert."
  - type: "decision"
    eyebrow: "Kaufentscheidung"
    title: "Diese fünf Fragen führen zum passenden System"
    items:
      - "Trockenfutter oder Nassfutter?"
      - "Katze, kleiner Hund oder großer Hund?"
      - "Ein Tier oder mehrere Tiere mit Futterneid?"
      - "Reicht ein Zeitplan oder brauchst du App beziehungsweise Kamera?"
      - "Laufen Zeitpläne auch ohne Internet und gibt es eine Notstromversorgung?"
  - type: "checks"
  ...
  - type: "mistakes"
    eyebrow: "Typische Fehlkäufe"
    title: "Nicht von der längsten Funktionsliste täuschen lassen"
    cards:
      - title: "Kamera statt Zuverlässigkeit"
        text: "Video ist ein Zusatz. Ein Automat muss zuerst pünktlich, reproduzierbar und auch bei Störungen füttern."
      - title: "Liter statt Tagesration vergleichen"
        text: "Behältervolumen sagt wenig über die tatsächliche Reichweite aus. Rechne mit Futtergewicht und Tagesmenge."
      - title: "Portionsangabe ungeprüft übernehmen"
        text: "Eine Portion ist häufig ein Förderschritt, kein festes Grammgewicht. Krokettenform und Dichte verändern die Menge."
      - title: "Mehrtiertauglichkeit voraussetzen"
        text: "Zwei Näpfe garantieren weder gleiche Verteilung noch individuellen Zugang."
  - type: "products"
...
comparisonRecommendation:
  title: "Nicht das smarteste Modell, sondern die passende Bauart gewinnt"
  text: "Für die meisten Haushalte ist ein Trockenfutterautomat mit App, lokalen Zeitplänen und Batterie-Backup der vielseitigste Ausgangspunkt. Kamera-Modelle eignen sich für zusätzliche Sichtkontrolle. Bei Nassfutter ist ein Fachsystem wie der Cat Mate C500 konstruktiv passender als ein Vorratsautomat."
  tableTitle: "Sechs unterschiedliche Futterautomaten direkt verglichen"
  cardsTitle: "Modelle und Einsatzgebiete im Detail"
  criteria:
    - "Futterart"
    - "Tier & Einsatzgebiet"
    - "App & Zeitpläne"
    ...
    - "Sicherheit"
healthBridge:
  eyebrow: "Gesundheit & Fressverhalten"
  title: "Ein Futterautomat organisiert Mahlzeiten – er diagnostiziert nicht"
  text: "Protokollierte Ausgaben zeigen nur, dass der Automat Futter bereitgestellt hat. Sie belegen nicht, welches Tier gefressen hat oder ob die Portion vollständig aufgenommen wurde. Plötzliche Futterverweigerung, häufiges Erbrechen, deutlicher Gewichtsverlust oder Apathie müssen unabhängig von der Technik abgeklärt werden."
  href: "/hund-frisst-nicht/"
  cta: "Warnzeichen richtig einordnen"
closingCta:
  title: "Starte mit Tier, Futterart und Alltag"
  text: "Vergleiche anschließend nur Modelle, die deine drei wichtigsten Anforderungen erfüllen. So vermeidest du, für Kamera, Audio oder Cloud-Funktionen zu bezahlen, obwohl Zuverlässigkeit, Reinigung und Portionierung entscheidender sind."
  productKey: "petlibro-granary-wifi-feeder"
  primaryLabel: "Ausgewähltes Modell ansehen"
  secondaryHref: "/welcher-futterautomat-ist-der-richtige/"
  secondaryLabel: "Ausführliche Auswahlhilfe lesen"
faq:
  - question: "Was ist ein smarter Futterautomat?"
    answer: "Ein smarter Futterautomat gibt Futter nach einem Zeitplan oder App-Befehl aus und kann je nach Modell Ausgaben protokollieren, Füllstände melden oder ein Kamerabild übertragen. Smarte Funktionen unterscheiden sich deutlich; ein Gerät ohne WLAN kann trotzdem zuverlässiger zur Fütterungsroutine passen."
  - question: "Welcher smarte Futterautomat ist der beste?"
    answer: "Den besten Automaten für alle Tiere gibt es nicht. Für Trockenfutter sind lokal gespeicherte Zeitpläne, reproduzierbare Portionen, Notstrom und gute Reinigung meist wichtiger als Kamera oder Audio. Für Nassfutter wird eine andere Bauart mit Portionsfächern und Kühlung benötigt."
  - question: "Ist ein smarter Futterautomat für Katzen und Hunde geeignet?"
    answer: "Viele Vorratsautomaten eignen sich für Katzen sowie kleine bis mittelgroße Hunde. Entscheidend sind Napfhöhe, Stabilität, kleinste und größte Portionsmenge, Krokettengröße und Behälterkapazität. Für große Hunde sind nicht alle Modelle ausreichend dimensioniert."
  - question: "Braucht ein Futterautomat WLAN?"
    answer: "Nein. Ein zuverlässiger Zeitplan kann auch ohne WLAN funktionieren. WLAN ist sinnvoll für Fernsteuerung, Protokolle und Benachrichtigungen. Wichtig ist, dass geplante Mahlzeiten bei einem Internet- oder Routerausfall lokal weiterlaufen."
  - question: "Funktioniert ein smarter Futterautomat bei Stromausfall?"
    answer: "Nur Modelle mit Batterie-Backup oder anderer Notstromversorgung können bei einem Stromausfall weiterarbeiten. Ob alle Funktionen erhalten bleiben und Zeitpläne lokal gespeichert sind, muss für das konkrete Modell geprüft werden."
  - question: "Kann ich Nassfutter in einen smarten Vorratsautomaten füllen?"
    answer: "Nein. Klassische Vorratsautomaten mit Fördermechanismus sind für trockenes Futter ausgelegt. Nassfutter gehört in geschlossene Portionsfächer mit geeigneter Kühlung und hygienisch begrenzter Standzeit."
  - question: "Sind die Portionen eines Futterautomaten grammgenau?"
    answer: "Meist nicht vollständig. Viele Geräte dosieren nach Förderschritten oder Volumen. Größe, Form und Dichte der Kroketten verändern das tatsächliche Gewicht. Deshalb sollten mehrere Ausgaben mit dem eigenen Futter nachgewogen werden."
  - question: "Ist ein Futterautomat für zwei Katzen geeignet?"
    answer: "Ein Doppelnapf kann Futter auf zwei Schalen verteilen, garantiert aber keine gerechte Aufnahme. Frisst eine Katze schneller oder verteidigt den Napf, ist eine individuelle Zugangskontrolle oder räumlich getrennte Fütterung sinnvoller."
  - question: "Lohnt sich eine Kamera im Futterautomaten?"
    answer: "Eine Kamera lohnt sich, wenn du den Futterplatz aus der Ferne kontrollieren möchtest. Sie kann zeigen, ob ein Tier erscheint, beweist aber nicht zuverlässig, wie viel es gefressen hat. Achte zusätzlich auf Datenschutz, Speicheroptionen und mögliche Abokosten."
  - question: "Kann ein Futterautomat beim Abnehmen helfen?"
    answer: "Er kann eine festgelegte Tagesration in mehrere kleine Mahlzeiten aufteilen. Die Tagesmenge muss jedoch korrekt berechnet und die tatsächliche Ausgabe nachgewogen werden. Ein Automat ersetzt keine tierärztliche oder ernährungsmedizinische Beratung."
  - question: "Wie groß sollte der Vorratsbehälter sein?"
    answer: "Rechne mit dem Gewicht der täglichen Trockenfutterration statt nur mit Litern. Ein sehr großer Behälter ist nicht automatisch besser, weil Futter lange lagert und das Gerät mehr Platz benötigt. Die Reichweite sollte zur Kontrollfrequenz passen."
  - question: "Wie oft muss ein Futterautomat gereinigt werden?"
    answer: "Napf und Futterauslass sollten regelmäßig auf Krümel, Fettfilm und Feuchtigkeit geprüft und entsprechend der Modellanleitung gereinigt werden. Behälter, Rotor und Dichtungen benötigen ebenfalls planmäßige Reinigung, bevor sich Rückstände oder Biofilm bilden."
  - question: "Kann ein Futterautomat im Urlaub die Betreuung ersetzen?"
    answer: "Nein. Eine verantwortliche Person muss Wasser, Futteraufnahme, Gesundheitszustand, Hygiene und Funktion des Geräts regelmäßig vor Ort kontrollieren. Ein Automat ist eine Fütterungshilfe, keine vollständige Urlaubsbetreuung."
  - question: "Was ist wichtiger: App oder Batterie-Backup?"
...
Zwei Näpfe lösen nur das Verteilungsproblem. Sie verhindern nicht, dass ein Tier beide Portionen frisst.

| Situation | Passende Lösung |
|---|---|
| Tiere fressen ruhig nebeneinander | Doppelnapf oder geteilter Auslass |
| ein Tier frisst deutlich schneller | getrennte Futterplätze oder getrennte Automaten |
...
![Übersicht der wichtigsten Bauarten smarter Futterautomaten für Trockenfutter, Nassfutter und Mehrtierhaushalte.](../../assets/images/guides/smarte-futterautomaten/feeder-types.webp)
...
![Vergleichsmatrix der Futterautomaten-Bauarten nach Futterart, Zeitplan, App, Kamera und Zugangskontrolle.](../../assets/images/guides/smarte-futterautomaten/comparison-overview.webp)
...
| Funktion | Klassischer Timer | Smarter Automat |
|---|---:|---:|
| feste Mahlzeiten | ja | ja |
| spontane Ausgabe aus der Ferne | nein | meist ja |
| Ausgabeprotokoll | selten | häufig |
| Störungsmeldungen | selten | modellabhängig |
| Kamera | nein | bei ausgewählten Modellen |
| Cloud- oder Kontoabhängigkeit | nein | möglich |
| Nutzung ohne Internet | meist vollständig | modellabhängig |
...
![Schematische Darstellung von Rotor, Förderschnecke und Drehteller als Dosiersysteme in Futterautomaten.](../../assets/images/guides/smarte-futterautomaten/portioning-system.webp)
...
![Ablauf einer automatischen Futterausgabe vom Zeitplan über Mechanik und Sensorik bis zum Napf.](../../assets/images/guides/smarte-futterautomaten/feeding-workflow.webp)
...
![Infografik zu den Unterschieden zwischen lokalem Zeitplan, WLAN, Internet, Hersteller-Cloud und Smartphone-App.](../../assets/images/guides/smarte-futterautomaten/offline-vs-cloud.webp)
...
![Kaufcheckliste für smarte Futterautomaten mit Portionierung, Ausfallsicherheit, Reinigung und Sicherheit.](../../assets/images/guides/smarte-futterautomaten/buying-checklist.webp)
...
Ein guter smarter Automat speichert Zeitpläne im Gerät. Fällt WLAN oder Internet aus, sollten geplante Mahlzeiten trotzdem ausgegeben werden. App-Steuerung, Livebild und Benachrichtigungen können währenddessen ausfallen.

### 4. Stromversorgung

Ein Batterie-Backup schützt vor Stromausfall. Prüfe benötigte Batterien, Reserve- oder Vollbetrieb, Batteriestandsmeldung und verfügbare Funktionen im Batteriebetrieb.

### 5. Futterkanal und Krokettengröße

Große, flache, unregelmäßige oder fetthaltige Kroketten können anders dosiert werden oder einen Stau begünstigen. Die Herstellerangabe zur Krokettengröße ist deshalb wichtiger als das reine Behältervolumen.

### 6. Reinigung

Alle Teile mit direktem Futterkontakt sollten gut erreichbar sein. Besonders kritisch sind Napf, Auslass, Rotor, Behälterboden, Dichtungen, Deckel und schwer zugängliche Übergänge. Eine ausführliche Anleitung findest du unter [Futterautomat richtig reinigen](/futterautomat-richtig-reinigen/).

### 7. Sicherheit

Der Automat sollte gegen Umkippen, Aufhebeln und Hineingreifen geschützt sein. Prüfe auch Kabel, Batteriefach und bewegliche Teile. Bei sehr futtermotivierten Hunden ist eine robuste Verriegelung besonders wichtig.
...
Der Automat hält geplante Fütterungszeiten ein, auch wenn sich der Heimweg verschiebt. Trotzdem muss eine zuverlässige Betreuung für Wasser, Gesundheit und technische Kontrolle bestehen.

### Katzen mit mehreren kleinen Mahlzeiten

Viele kleine Ausgaben lassen sich besser über den Tag verteilen. Die korrekte Tagesration bleibt entscheidend.

### Tiere im Gewichtsmanagement

Ein Automat kann eine festgelegte Tagesmenge konsequent aufteilen. Er berechnet den Energiebedarf jedoch nicht und kontrolliert nicht, ob ein anderes Tier die Portion frisst.

### Sehr früh futterfordernde Katzen

Eine automatisch ausgegebene frühe Mahlzeit kann die Verknüpfung zwischen Wecken und Füttern reduzieren. Verhaltensänderungen brauchen dennoch eine konsequente Routine.
...
Ein Automat ist ungeeignet als alleinige Lösung, wenn ein Tier plötzlich nicht frisst, häufig erbricht oder regurgitiert, Schluckprobleme bestehen, Medikamente mit kontrollierter Mahlzeit gegeben werden müssen, individuelle Diäten ohne getrennten Zugang nötig sind oder das Gerät mehrere Tage ohne persönliche Kontrolle arbeiten soll.

Bei verändertem Fressverhalten helfen die Ratgeber [Hund frisst nicht](/hund-frisst-nicht/) und [Katze frisst nicht](/katze-frisst-nicht/) bei der ersten Einordnung.
...
Sinnvolle smarte Funktionen sind bequem änderbare Zeitpläne, spontane Ausgaben, Ausgabeprotokolle, Füllstandsmeldungen, Störungsanzeigen und eine Sichtkontrolle per Kamera.
...
![Datenschutz- und Sicherheitscheck für Futterautomaten mit Kamera, Mikrofon, App und Cloud-Speicher.](../../assets/images/guides/smarte-futterautomaten/privacy-security.webp)
...
![Wartungskalender für Futterautomaten mit täglichen, wöchentlichen und monatlichen Kontrollen.](../../assets/images/guides/smarte-futterautomaten/maintenance-calendar.webp)
...
![Häufige Fehlkäufe bei smarten Futterautomaten wie ungeprüfte Portionen, Cloud-Abhängigkeit und ungeeignete Mehrtierlösungen.](../../assets/images/guides/smarte-futterautomaten/common-mistakes.webp)
...
![Mobile Abschlusscheckliste zur Auswahl und sicheren Einrichtung eines smarten Futterautomaten.](../../assets/images/guides/smarte-futterautomaten/final-checklist.webp)
