...
litterCompatibility: { bentoniteClumping: { status: unknown }, tofu: { status: conditional, condition: "Klumpend; ultrafeine Sorten ausgeschlossen." }, plantBased: { status: conditional, condition: "Nur belegte Mischstreu; sehr feine Gras-/Maniokstreu ausgeschlossen." }, woodPellets: { status: notSupported, condition: "Kiefernstreu ausgeschlossen." }, crystal: { status: notSupported }, nonClumping: { status: unknown }, evidenceSourceUrls: ["https://de.petlibro.com/products/luma-intelligente-selbstreinigende-katzentoilette-exclusive"] }
