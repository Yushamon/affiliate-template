...
litterCompatibility: { bentoniteClumping: { status: notSupported, condition: "System verlangt PETKIT Crystal Litter Set." }, tofu: { status: notSupported }, plantBased: { status: notSupported }, woodPellets: { status: notSupported }, crystal: { status: supported, condition: "Nur PETKIT Crystal Litter Set mit Einwegschale." }, nonClumping: { status: notSupported }, evidenceSourceUrls: ["https://www.petkit-eu.com/de/products/purobot-crystal-duo-automatic-cat-litter-box-with-camera"] }
