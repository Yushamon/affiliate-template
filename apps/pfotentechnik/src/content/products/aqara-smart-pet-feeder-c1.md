...
seo: { title: "Aqara Smart Pet Feeder C1 Test", description: "Aqara Smart Pet Feeder C1 im Recherche-Test: Zigbee, Hub, Portionen, Batterie-Backup, Erfahrungen und Schwächen.", canonical: "/produkt/aqara-smart-pet-feeder-c1/", sitemap: true, priority: 0.9 }
...
rating: 4.4
score: 88
ratings: { verarbeitung: 4.4, bedienung: 4.2, app: 4.3, zuverlässigkeit: 4.5, preisleistung: 4.3, reinigung: 4.5, smartHome: 4.7 }
decision:
  bestFor: ["Aqara-Smart-Home", "Katzen und kleine Hunde", "Lokale Zeitpläne", "Batterie-Backup"]
  attention: ["Aqara Zigbee Hub erforderlich", "Keine Kamera", "Portionsgramm müssen selbst kalibriert werden", "Nur Trockenfutter"]
review:
  summary: "Der C1 verbindet einen 4-Liter-Behälter mit Zigbee-Automationen, lokal gespeicherten Zeitplänen und optionalem Batteriebetrieb."
  verdict: "Im Aqara-Ökosystem ungewöhnlich flexibel und ausfallsicher. Ohne vorhandenen Hub verliert das Preis-Leistungs-Verhältnis deutlich."
strengths: ["Zeitpläne laufen ohne Internet weiter", "Zigbee-Automationen", "Batterie-Backup", "4-Liter-Vorrat", "Entnehmbare Futterteile", "Edelstahl-Napf"]
weaknesses: ["Zusätzlicher Aqara Hub nötig", "Keine direkte Gewichtsmessung", "Keine Kamera oder Tiererkennung", "Portionen schwanken je nach Kroketten"]
experience:
  summary: "Nutzerberichte loben funktionierendes Batterie-Backup und stabile Routinen. Kritik betrifft Einrichtung, Hub-Abhängigkeit und Schwankungen bei unregelmäßigen Kroketten."
  positives: ["Zeitpläne bleiben lokal aktiv", "Batterie-Backup wurde in Nutzerberichten bestätigt", "Siri- und Smart-Home-Szenen sind möglich"]
  criticism: ["Einzelne Reset- und Einrichtungsprobleme", "Hub verursacht Zusatzkosten", "Grammstatistik basiert auf kalibrierter Portion statt echter Waage"]
  methodology: "Offizielle Aqara-Daten, FAQ, Handbuch und öffentliche Langzeitberichte; kein eigener Langzeittest."
alternatives: ["xiaomi-smart-pet-food-feeder-2", "pawsync-smart-pet-feeder", "petlibro-air-wifi-feeder"]
comparisons: ["beste-futterautomaten-fuer-katzen", "beste-futterautomaten-fuer-hunde", "beste-futterautomaten-ohne-wlan"]
specs:
