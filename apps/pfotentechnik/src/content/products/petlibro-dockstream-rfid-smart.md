...
recommendation: >-
  Spezialisierte Wahl für Mehrkatzenhaushalte, wenn Trinkmenge, Häufigkeit und Dauer pro Tier getrennt protokolliert
  werden sollen.
manufacturer:
  key: petlibro
  name: PETLIBRO
...
experience:
  summary: >-
    ...
    kontrollierte Trinkmengenmessung.
...
specs:
  ...
  - label: Reinigung
    value: Tank, Trinkfläche, Rotor und Filterbereich regelmäßig reinigen. Filter etwa alle zwei Wochen wechseln.
  - label: Akku
    value: Nein
  - label: UV
...
faq:
  ...
  - question: Kann der Anhänger einen Mikrochip-Futterautomaten stören?
    answer: >-
      PETLIBRO weist darauf hin, dass der RFID-Anhänger die Funktion fremder Mikrochip-Futterautomaten beeinflussen
      kann.
  - question: Ist der Brunnen für Hunde geeignet?
    answer: >-
      PETLIBRO ordnet ihn primär Katzen und kleinen Hunden zu. Für mittelgroße und große Hunde empfiehlt der Hersteller
      die Capsule Dog Fountain.
comparisonData:
  general:
    animal:
      - dog
  ...
  custom:
    ...
    tiererkennung: PETLIBRO-RFID-Halsbandanhänger
    anzahl_tiere: Tracking für bis zu fünf Katzen
    app: PETLIBRO-App
    verbindung: 2,4-GHz-WLAN
    stromversorgung: kabelgebunden, 5 V/1 A
    lautstarke: Herstellerangabe 23 dB
    filter: mehrstufig
    filterwechsel: Herstellerempfehlung etwa alle zwei Wochen
    abmessungen: 245 × 200 × 231 mm
    gewicht: 1,6 kg
