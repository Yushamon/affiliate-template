...
const NAME = "pfotentechnik-seo-copilot-action-guarantee-22.10.9";
...
const REPORT = path.join(APP, "reports", "seo-copilot", "action-guarantee-22.10.9.md");
...
const reportContent = `# SEO Copilot Action Guarantee 22.10.9
