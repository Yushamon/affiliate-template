...
const NAME = "pfotentechnik-seo-copilot-finding-ai-null-safety-22.10.5";
...
const REPORT = path.join(REPORT_DIR, "finding-ai-null-safety-22.10.5.md");
...
const reportContent = `# Finding AI Null Safety 22.10.5

## Korrektur gegenüber 22.10.3

22.10.3 erwartete eine zu enge Formatierung von \`finding-ai.ts\`.
22.10.5 erkennt den Zugriff auf \`finding.aiActionIds.map()\` unabhängig von
