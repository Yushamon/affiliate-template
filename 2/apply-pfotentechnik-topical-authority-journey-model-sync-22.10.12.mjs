...
const NAME = "pfotentechnik-topical-authority-journey-model-sync-22.10.12";
...
const REPORT = path.join(APP, "reports", "seo-copilot", "topical-authority-journey-model-22.10.12.md");
...
const reportContent = `# Topical Authority Journey Model Sync 22.10.12
